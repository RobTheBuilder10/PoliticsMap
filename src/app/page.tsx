  ...
  return (
    <div className="flex flex-col lg:flex-row h-[calc(100vh-3.5rem)]">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {/* Map Container */}
        <div className="flex-1 overflow-auto p-2 sm:p-4 bg-surface-100 dark:bg-surface-900">
        ...
        {/* Summary Bar */}
        <div className="flex-shrink-0 border-t border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-800 p-3 sm:p-4">
      ...
      <aside
        className={cn(
          ...
          'fixed lg:relative inset-y-0 right-0 z-20 w-full sm:w-96 transform transition-transform duration-300 ease-in-out',
